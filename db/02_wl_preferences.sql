...
CREATE TABLE wl_preferences (
    ...
    user_id    INT UNSIGNED NOT NULL COMMENT 'references auth.auth_accounts.id',
...
-- auth.auth_accounts is accessible cross-DB from the wlmonitor DB.
...
-- ALTER TABLE auth.auth_accounts DROP COLUMN departures;
